...
//w refers to width and h refers to height, using tailwind css we are defining css in line here
export default function Nav({show}) {
    const inactiveLink = 'flex gap-1 p-1';
    const activeLink = inactiveLink+' bg-red-100 text-black rounded-md';
    const inactiveIcon = 'w-6 h-6';
    const activeIcon = inactiveIcon + ' text-red-800';
